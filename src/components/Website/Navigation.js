...
const Navigation = ({ noheader, ishome }) => {
  ...
  return (
    <StyledNavigation
      className={noheader ? "no-header" : ishome ? "is-home" : null}
    >
      <div className="site-logo">
        <img
          src={logo}
          alt="Refugee Stories Logo"
          style={{ width: "330%", marginTop: "0" }}
        />
      </div>
    ...
    @media (max-width: 768px) {
      ...
      &.open {
        ...
        &:before {
          ...
          border-width: 14px;
          border-color: ${(props) => props.theme.primaryGrey} transparent
